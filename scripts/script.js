...
let modelName = modelNameElement.innerHTML;
let duration = parseInt(durationElement.innerHTML);
...
function changeModel() {
  if (modelName === "Model XYZ") {
      ...
      modelNameElement.innerHTML = "Model CPRG";
  } else if (modelName === "Model CPRG") {
      modelName = "Model XYZ";
      modelNameElement.innerHTML = "Model XYZ";
